...
for result in results:
    newlist.append(result.find_element(By.XPATH, "h4").text)
    result.find_element(By.XPATH, "div/button").click() #chaining web elements
print(newlist)
assert newlist == list
...
#sum validation
#prices = driver.find_elements(By.XPATH, "//td/tr[5]")
